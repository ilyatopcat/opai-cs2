...
class CSubtickMoveStep final :
 ...
 public:
  ...
  void SetAnalogForwardDelta(float value);
  private:
  ...
  void SetAnalogLeftDelta(float value);
  private:
...
class CBaseUserCmdPB final :
 ...
 public:
  ...
  ::CSubtickMoveStep* AddSubtickMoves();
...
inline void CSubtickMoveStep::SetButton(uint64_t value) {
...
inline void CSubtickMoveStep::SetPressed(bool value) {
...
inline void CSubtickMoveStep::SetWhen(float value) {
...
inline void CSubtickMoveStep::SetAnalogForwardDelta(float value) {
...
inline void CSubtickMoveStep::SetAnalogLeftDelta(float value) {
...
inline ::CSubtickMoveStep* CBaseUserCmdPB::AddSubtickMoves() {
